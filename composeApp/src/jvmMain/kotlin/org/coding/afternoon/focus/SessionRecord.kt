...
data class SessionRecord(
    ...
    companion object {
        ...
        fun now(durationMinutes: Int): SessionRecord {
        ...
        fun toJson(record: SessionRecord): String =
            """{"date":"${record.date}","startTime":"${record.startTime}","durationMinutes":${record.durationMinutes}}"""
        ...
        fun fromJson(json: String): SessionRecord? {
            return try {
                ...
                SessionRecord(date, startTime, duration)
            } catch (_: Exception) {
                null
            }
        }
